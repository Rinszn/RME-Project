...
>
  ...
  <header className="hero bg-light d-flex align-items-center" style={{ minHeight: '100vh' }}>
    <div className="container text-center">
      ...
      <Link href="#" onClick={(e) => scrollToSection(e, 'features')}  className="btn btn-primary btn-lg rounded-pill" data-aos="fade-up" data-aos-delay="200">
        See Below
      </Link>
    </div>
  </header>
    ...
    <div className="row">
      ...
      <div className="col-md-4 mb-4">
        ...
        <ul className="list-unstyled small">
          ...
          <li><Link href="#" className="text-light text-decoration-none">Features</Link></li>
          <li><Link href="#" className="text-light text-decoration-none">How It Works</Link></li>
          <li><Link href="#" className="text-light text-decoration-none">Plans</Link></li>
      ...
      <div className="col-md-4 mb-4">
        ...
        <div className="d-flex gap-3 mt-2">
          <Link href="#" className="text-light"><i className="bi bi-facebook"></i></Link>
          <Link href="#" className="text-light"><i className="bi bi-instagram"></i></Link>
          <Link href="#" className="text-light"><i className="bi bi-twitter-x"></i></Link>
        </div>
      </div>
    </div>
...
{showLoginForm && (
  ...
  >
    <div
      className="bg-white rounded-4 shadow position-relative overflow-hidden"
      style={{
        width: '100%',
        maxWidth: '900px', // wider for split design
        minHeight: '500px' // keep tall enough for both sides
      }}
    >
      ...
      {/* Login component handles its own layout */}
